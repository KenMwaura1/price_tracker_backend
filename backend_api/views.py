...
"""
    def new_product(self, form):
        ...
        import sys
        # this path will remain in sys.path until this program terminated
        sys.path.append("/app")
...
class ProductUpdateView(LoginRequiredMixin, UserPassesTestMixin, UpdateView):
    ...
    def test_func(self):  # this function restrict user to update others post..he can update only his own post not others
        # UserPassesTestMixin that's why we write this
...
def register(request):
    ...
    return render(request, 'users/register.html', my_form)
